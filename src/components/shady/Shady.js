    ...
    render(){
        return(
            <div className="speech__bubble">
                <div className="shady__words"> {this.words}</div>
                <form>
                    <input className="shady__input" type="text" placeholder=""/>
                    <button onClick={this.sendAlert} className="tellshady__button">Tell Shady</button>
                </form>
            </div>
        )
    }
...
class Tip extends React.Component {
    ...
    render(){
        ...
        return(
            <div className="speech__bubble">
                <div className="shady__tip">Tip: </div>
                <div className="shady__words"> {this.words}</div>
            </div>
        )
    }
    ...
    render(){
        return(
            <div className="speech__bubble">
                <div className="shady__words"> {this.words}</div>
                <form>
                    <button onClick={this.sendAlert} className="tellshady__button">Here!</button>
                </form>
            </div>
        )
    }
